...
export default function Myzone() {
  ...
  function validateAddProduct() {
    let schema = Joi.object({
      ...
      propertyDesc: Joi.object({
        ...
        finishingType: Joi.string().valid(
          "super lux",
          "lux",
          "without finished",
          "Garden",
  ...
  async function sendData() {
    await axios
      .post(
        `https://zunis-node-js.vercel.app/product/create?categoryId=${id}`,
        formDataToSend,
        {
          headers: {
      ...
      <div className="container py-5">
        <div className={`  my-5  `}>
          <div className=" ">
            <form
              onSubmit={submitForm}
              className={`w-100 p-5 border-0`}
              action=""
              encType="multibart/form-data"
            >
              ...
              <div className="form-group my-4">
                ...
                <input
                  onChange={getItemSpecial}
                  id="yearsOfConstruction"
                  type="text"
                  placeholder="مثال : 2002"
                  className="w-100 p-2  "
                  name="yearOfConstruction"
                  value={propertyDesc.yearOfConstruction}
                />
              </div>
              <div className="form-group my-4">
